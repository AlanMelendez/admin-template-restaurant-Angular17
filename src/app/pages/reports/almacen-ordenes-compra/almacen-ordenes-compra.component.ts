...
@Component({
  ...
  templateUrl: './almacen-ordenes-compra.component.html',
  styleUrl: './almacen-ordenes-compra.component.css'
})
export class AlmacenOrdenesCompraComponent {
      ...
      this.displayedColumns.forEach((column) => {
        switch (column) {
          ...
          case 'Descripcion':
            ...
            break;
          case 'Proveedor':
            rowData[column] = `Proveedor ${i}`;
            break;
          case 'Estatus':
            rowData[column] =  `Estatus ${i}`;
            break;
          case 'ImporteTotal':
            rowData[column] = i;
            break;
